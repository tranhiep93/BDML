    ...
    <section class="top row">
        ...
        <div class="col-8" style="padding-top: 5px;font-size: 17px;">
            <div style="text-align: center">
                <b>BƯU ĐIỆN HUYỆN MÊ LINH</b><br/><i>Trụ sở chính: Khu hành chính Huyện Mê Linh-Đại Thịnh-Mê Linh-Hà Nội</i><br/><b>VHX TIẾN THỊNH: NGUYỄN THỊ THANH HẢI-0374084699</b>
            </div>
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td colspan="3" style="text-align: left; padding-left: 5px; font-size: 18px;">
                        <span style="">⚠️Thông báo: <br/></span>Từ ngày 1/7/2022, <strong>Có thể cấp, đổi thẻ BHYT tự nguyện tại điểm Bưu điện tiến thịnh.</strong> Thẻ được nối tiếp ngay đảm bảo <strong>quyền lợi khám chữa bệnh bằng BHYT</strong>.</span>
                    </td>
                </tr>
		<tr>
		<td colspan="3" style="text-align: left; padding-left: 5px; font-size: 18px;">
